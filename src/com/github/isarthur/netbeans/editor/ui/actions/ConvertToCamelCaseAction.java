...
@ActionID(
        category = "Edit",
        id = "nb.editor.ui.actions.ConvertToCamelCaseAction"
)
@ActionRegistration(
...
@Messages("CTL_ConvertToCamelCaseAction=Convert to camelCase")
public class ConvertToCamelCaseAction extends ConvertToAction {
