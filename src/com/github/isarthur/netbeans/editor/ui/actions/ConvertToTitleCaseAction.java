...
@ActionID(
        category = "Edit",
        id = "nb.editor.ui.actions.ConvertToTitleCaseAction"
)
@ActionRegistration(
...
@Messages("CTL_ConvertToTitleCaseAction=Convert to TitleCase")
public class ConvertToTitleCaseAction extends ConvertToAction {
