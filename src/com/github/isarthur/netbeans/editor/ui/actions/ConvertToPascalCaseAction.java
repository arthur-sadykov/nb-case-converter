...
@ActionID(
        category = "Edit",
        id = "nb.editor.ui.actions.ConvertToPascalCaseAction"
)
@ActionRegistration(
...
@Messages("CTL_ConvertToPascalCaseAction=Convert to PascalCase")
public class ConvertToPascalCaseAction extends ConvertToAction {
